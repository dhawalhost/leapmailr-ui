...
export default function NewTemplatePage() {
  ...
  const initialHtmlBody = searchParams.get('html_body') || '';
  const initialTextBody = searchParams.get('text_body') || '';

  const [formData, setFormData] = useState({
    name: initialName,
    subject: initialSubject,
    html_body: initialHtmlBody,
    text_body: initialTextBody,
  });
  ...
  useEffect(() => {
    ...
    // Auto-populate manual variables field if empty
