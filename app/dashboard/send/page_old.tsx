...
export default function SendEmailPage() {
  ...
  // Helper function to parse variables (can be JSON string or array)
  const parseVariables = (variables: string | string[] | undefined): string[] => {
    if (!variables) return [];
  ...
  const loadTemplates = async () => {
    try {
      setLoading(true);
      const response = await templateAPI.list({ is_active: true });
